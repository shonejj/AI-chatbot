document.addEventListener('DOMContentLoaded', function() {
    ...
    function sendMessageToGroqAPI(message) {
            ...
            messages: [
                {
                    role: 'system',
                    content: `
                        Generate only JSON data in the specified format no more additional text . Do not include any text or explanation , also use this below jsonData format as a reference to generate the chart for the defined function.
                        jsonData = {
        ...
        .then(data => {
            ...
            generateChart(JSON.parse(botMessage)); // Generate chart with the returned JSON data
        })
        .catch(error => {
            ...
            messages: [
                {
                    role: 'system',
                    content: `
                        Generate only JSON data in the specified format. Do not include any text or explanation , also use this below jsonData format as a reference to generate the chart for the defined function.
                        jsonData = {
                            "chartType": "bar", // or "line", "pie"
                            "data": {
                                "labels": ["January", "February", "March", "April", "May"],
